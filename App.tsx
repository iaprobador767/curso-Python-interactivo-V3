  ...
  return (
    <div className="container mx-auto max-w-4xl px-2 sm:px-4 pb-10">
      ...
      <footer className="text-center text-sm text-slate-500 mt-12 py-6 border-t border-slate-700">
        <p>&copy; {new Date().getFullYear()} Curso Interactivo de Python. Mejorado con React, Tailwind y Gemini AI.</p>
        <p>Inspirado en el código original y llevado al siguiente nivel.</p>
      </footer>
    </div>
  );
};
